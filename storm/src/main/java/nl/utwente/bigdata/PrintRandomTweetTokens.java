...
import nl.utwente.bigdata.bolts.CountingBolt;
...
public class PrintRandomTweetTokens extends AbstractTopologyRunner {   
	...
	protected StormTopology buildTopology(Properties properties) {
		...
		boltId = "counter"; 
		builder.setBolt(boltId, new CountingBolt()).shuffleGrouping(prevId);
		prevId = boltId;
    ...
    public static void main(String[] args) {
    	new PrintRandomTweetTokens().run(args);;
    }
}
